            ...
            <div class="flex flex-col mx-5 mt-6 lg:flex-row">
                    ...
                    <form class="w-full bg-white shadow-md p-6 " @submit.prevent="">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-full px-3 mb-6">
                                ...
                                <input v-model.trim="title" maxlength="100"
                ...
                <div class="w-full lg:w-2/3 m-1 bg-white shadow-lg text-lg rounded-sm border border-gray-200">
                    <div class="rounded-lg p-3">
                        <h2> <strong>HIGH PRIORITY</strong></h2>
                        <hr>
                        <div class=" overflow-x-auto flex sm:flex-row gap-5 mt-5">
                            <div v-for="element in taskStore.tasks" v-bind:key="element.id" class="snap-x snap-mandatory">
                                <div v-if="compareEmail == element.createdBy && element.priority == 'High'"
                                    class="snap-always snap-center bg-white w-full border-b-4 border-yellow-900 rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
                                    <div class="bg-yellow-900  flex h-20 w-80  items-center">
                    ...
                    <div class="rounded-lg p-3">
                        <h2> <strong>Medium PRIORITY</strong></h2>
                        <hr>
                        <div class=" overflow-x-auto flex sm:flex-row gap-5 mt-5">
                            <div v-for="element in taskStore.tasks" v-bind:key="element.id" class="snap-x snap-mandatory">
                                <div v-if="compareEmail == element.createdBy && element.priority == 'Medium'"
                                    class="snap-always snap-center bg-white w-full border-b-4 border-yellow-900 rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
                                    <div class="bg-yellow-900  flex h-20 w-80  items-center">
                                        <p class="ml-4 text-white uppercase"> {{ element.title.slice(0, 10) }} ... </p>
                                    </div>
                    ...
                    <div class="rounded-lg p-3">
                        <h2> <strong>LOW PRIORITY</strong></h2>
                        <hr>
                        <div class=" overflow-x-auto flex sm:flex-row gap-5 mt-5">
                            <div v-for="element in taskStore.tasks" v-bind:key="element.id" class="snap-x snap-mandatory">
                                <div v-if="compareEmail == element.createdBy && element.priority == 'Low'"
                                    class="snap-always snap-center bg-white w-full border-b-4 border-yellow-900 rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
                                    <div class="bg-yellow-900  flex h-20 w-80  items-center">
                                        <p class="ml-4 text-white uppercase"> {{ element.title.slice(0, 10) }} ... </p>
                                    </div>
